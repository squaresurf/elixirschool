...
Now that we've demostrated a basic example let's update our code to look at how `__using__/1` supports options.
...
If we give it a try in IEx we should see that the greeting is has changed:
